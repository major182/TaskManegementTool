...
public class CardController {
    ...
    public ResponseEntity<CardResponse> create(@PathVariable Long listId,
        ...
        Card card = cardService.create(currentUser.requireId(), listId, request.title());
    ...
    public CardResponse update(@PathVariable Long cardId,
                               @Valid @RequestBody CardUpdateRequest request) {
        return CardResponse.from(cardService.update(currentUser.requireId(), cardId,
    ...
    public ResponseEntity<Void> moveToTrash(@PathVariable Long cardId) {
        cardService.moveToTrash(currentUser.requireId(), cardId);
    ...
    public CardMoveResponse move(@PathVariable Long cardId,
                                 @Valid @RequestBody CardMoveRequest request) {
        return cardService.move(currentUser.requireId(), cardId, request.listId(), request.position());
    }
}
